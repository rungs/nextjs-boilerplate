import { TABLE_COMPANY_HEADER } from '@utils'

describe('TABLE_COMPANY_HEADER', () => {
  afterEach(() => {
    jest.clearAllMocks()
  })

  it('Call function TABLE_COMPANY_HEADER for renders table header', () => {
    const tableHeader = TABLE_COMPANY_HEADER()
  ...
  it('Call function TABLE_COMPANY_HEADER for renders table header is value null', () => {
    const tableHeader = TABLE_COMPANY_HEADER()
